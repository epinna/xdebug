...
PHP_INI_BEGIN()
	...
	STD_PHP_INI_ENTRY("xdebug.trace_enable_trigger_name",  "XDEBUG_TRACE",      PHP_INI_SYSTEM|PHP_INI_PERDIR,    OnUpdateString, trace_enable_trigger_name,  zend_xdebug_globals, xdebug_globals)
...
/* }}} */
	...
	if (
		(XG(auto_trace) || xdebug_trigger_enabled(XG(trace_enable_trigger), XG(trace_enable_trigger_name), XG(trace_enable_trigger_value) TSRMLS_CC))
